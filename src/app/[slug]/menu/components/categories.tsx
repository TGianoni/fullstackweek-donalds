...
const RestaurantCategories = ({ restaurant }: RestaurantCategoriesProps) => {
    const [selectedCategory, setSelectedCategory] = useState<MenuCategoriesWithProducts>(restaurant.manuCategories[0])
    ...
    <div className="relative z-50 mt-[-1.5rem] rounded-t-3xl bg-white">
      ...
      <ScrollArea className="w-full">
        <div className="flex w-max space-x-4 p-4 pt-0">
            {restaurant.manuCategories.map(category => (
      ...
      {products.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 flex w-full items-center justify-between bg-white border-t px-5 py-3">
          <div>
